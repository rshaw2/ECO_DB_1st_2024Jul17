...
namespace ECODB1st2024Jul17.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public EmailService(ECODB1st2024Jul17Context dbContext)
        {
        ...
        {
            var entityData = _dbContext.Email.FirstOrDefault(entity => entity.Id == id);
            return entityData;
        }
        ...
        private List<Email> GetEmail(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _dbContext.Email.AsQueryable();
