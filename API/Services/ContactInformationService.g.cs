...
namespace ECODB1st2024Jul17.Services
{
    ...
    public class ContactInformationService : IContactInformationService
    {
        ...
        public ContactInformationService(ECODB1st2024Jul17Context dbContext)
        {
        ...
        {
            var entityData = _dbContext.ContactInformation.FirstOrDefault(entity => entity.Id == id);
            return entityData;
        }
        ...
        private List<ContactInformation> GetContactInformation(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _dbContext.ContactInformation.AsQueryable();
