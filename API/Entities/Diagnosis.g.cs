...
#pragma warning disable
    ...
    public class Diagnosis
    {
        ...
        /// <summary>
        /// Foreign key referencing the Tenant to which the Diagnosis belongs 
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// Required field EntityCode of the Diagnosis 
        /// </summary>
        [Required]
        public string EntityCode { get; set; }

        /// <summary>
        /// Required field EntitySubTypeCode of the Diagnosis 
        /// </summary>
        [Required]
        public string EntitySubTypeCode { get; set; }

        /// <summary>
        /// Required field IsStandard of the Diagnosis 
        /// </summary>
        [Required]
        public bool IsStandard { get; set; }

        /// <summary>
        /// Foreign key referencing the User to which the Diagnosis belongs 
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// Required field CreatedOn of the Diagnosis 
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// Foreign key referencing the DiagnosisTemplate to which the Diagnosis belongs 
        /// </summary>
